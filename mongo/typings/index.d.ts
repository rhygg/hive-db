declare module "hive-db" {
	...
	export class HiveErr extends Error {
		message: string;
		name: string;
	...
	export class Database extends Base {
		...
		public init(key: string, value: any): Promise<any>;
		...
		public input(key: string, value: any | any[]): Promise<any>;
		...
		public exportToSqHive(): Promise<DataSet[]>;
