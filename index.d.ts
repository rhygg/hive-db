declare module 'hive-db' {
     ...
     * @param ops Any options to be added to the request.
     */
    function init(key: string, value: ValueData, ops?: Options): any;
     ...
     * @param ops Any options to be added to the request.
     */
    function input(key: string, value: ValueData, ops?: Options): any[];
     ...
     * @param ops Any options to be added to the request.
     */
    function array(ops?: Options): { ID: string; data: any; }[];
    ...
    class Table {
         ...
         * @param ops Any options to be added to the request.
         */
        public input(key: string, value: ValueData, ops?: Options): any[];
         ...
         * @param ops Any options to be added to the request.
         */
        public array(ops?: Options): { ID: string; data: any }[];
         ...
         * @param ops Any options to be added to the request.
         */
        public del(key: string, ops?: Options): boolean;
    }
